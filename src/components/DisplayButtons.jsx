...
const DisplayButtons = (props) => {
  ...
  return (
    <div className="btns">
      ...
      <Button handleClick={handleClick} value="%" />
      <Button handleClick={handleClick} value="÷" className="btn operator" />
      <Button handleClick={handleClick} value="7" />
      <Button handleClick={handleClick} value="8" />
      <Button handleClick={handleClick} value="9" />
      <Button handleClick={handleClick} value="x" className="btn operator" />
      ...
      <Button handleClick={handleClick} value="." />
      <Button value="=" handleClick={handleClick} className="btn operator" />
    </div>
  );
};
